  ...
  schemas: [
    [
      ...
      },
      {
        ...
        content:
          '{"companyAddress":"51 Rosetta st.","companyCountry":"Alexandria, Egypt","companyPhoneNmB":"+10001001","companyPhoneNmA":"+123123123","companyEmail":"info@acme.com"}',
        position: { x: 20, y: 50 },
        width: 70,
        height: 58,
        rotate: 0,
    ...
    [
      ...
      },
      {
        name: "payment",
        type: "multiVariableText",
        content: '{"advancePercentage":"25","postPercentage":"25"}',
        position: { x: 25, y: 175 },
        width: 165,
        height: 25,
        rotate: 0,
        ...
        underline: false,
        readOnly: false,
        text: "( {advancePercentage}% ) advance payment from the total price by certified cheque or cash\n( {postPercentage}% ) upon delivery through certified cheque or cash",
        variables: [],
        required: false,
        fontName: "readexPro",
      },
    ...
    [
      {
        ...
        height: 43.6424,
        content:
          '[["Eggshell Camisole Top","1","123","123", "EGP"],["Cuban Collar Shirt","2","127","254", "254", "EGP"]]',
        showHead: true,
        head: ["Item", "Qty", "Unit Price", "Total", "Cur"],
        headWidthPercentages: [35, 10, 20, 25, 10],
        fontName: "readexPro",
