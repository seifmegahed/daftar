...
function NewClientForm() {
  const t = useTranslations("clients.new-client-page");
    ...
    .object({
      ...
      registrationNumber: z.preprocess(
        ...
        z
          .string()
          .max(64, {
            message: t("schema.registration-number-max-length", { maxLength: 64 }),
          })
          .optional(),
      ),
      ...
      addressName: z.preprocess(
        ...
        z
          ...
          .min(4, { message: addressT("schema.name-min-length", { minLength: 4 }) })
          .max(64, {
      ...
      addressLine: z.preprocess(
        ...
        z
          ...
          .min(5, {
            message: addressT("schema.address-line-min-length", { minLength: 5 }),
          })
          .max(256, {
            message: addressT("schema.address-line-max-length", { maxLength: 256 }),
          }),
      ),
      ...
      contactName: z.preprocess(
        ...
        z
          ...
          .min(4, { message: contactT("schema.name-min-length", { minLength: 4 }) })
          .max(64, {
      ...
      phoneNumber: z.preprocess(
        ...
        z
          .string()
          .max(64, {
            message: contactT("schema.phone-number-max-length", { maxLength: 64 }),
          })
          .optional(),
      ),
      email: z.preprocess(
