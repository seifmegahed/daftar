...
import FilterAndSearch from "@/app/(auth)/documents/all-documents/filter-and-search";
import DocumentsList from "@/app/(auth)/documents/all-documents/documents-list";
